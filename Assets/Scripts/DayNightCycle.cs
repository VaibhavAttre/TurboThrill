...
public class DayNightCycle : MonoBehaviour
{
    ...
    {
        float timeFrac = timeOfDay / 24;
        RenderSettings.ambientEquatorColor = equatorColor.Evaluate(timeFrac);
        RenderSettings.ambientSkyColor = skyColor.Evaluate(timeFrac);
        sun.color = sunColor.Evaluate(timeFrac);
    }
}
